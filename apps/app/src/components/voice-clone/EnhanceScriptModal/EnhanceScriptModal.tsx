...
const RAW_SCRIPT = `આજે સવારે તો એટલો બધો ટ્રાફિક હતો કે હું પહોંચવામાં પૂરો એક કલાક મોડો પડ્યો. રોજ આ મેઈન સિગ્નલ પર આવીને ગાડી ઉભી જ રહી જાય છે અને કોઈ આગળ જ નથી વધતું. લોકોને જાણે કોઈ ઉતાવળ જ ના હોય એમ આરામથી વચ્ચે ગાડી લઈને ઉભા હોય છે. વળી પાછું વચ્ચે કોઈ બાઈક વાળો અચાનક કટ મારીને નીકળે એટલે સીધી બ્રેક મારવી પડે. હું તો કંટાળી ગયો છું રોજ સવારે આ ધુમાડા અને હોર્નના અવાજો સાંભળીને. કોર્પોરેશને હવે આ રોડને પહોળો કરવો જ પડશે અથવા કોઈ નવો બ્રિજ બનાવવો પડશે. નહીં તો આવતા બે વર્ષમાં તો અહીથી ચાલીને જવું પણ અઘરું થઈ જશે. કાલથી તો મેં નક્કી કર્યું છે કે ઘરેથી અડધો કલાક વહેલો જ નીકળી જઈશ. બાકી આ ટ્રાફિકમાં રોજ મગજ બગાડવા કરતા વહેલા નીકળવું વધારે સારું છે.`;
