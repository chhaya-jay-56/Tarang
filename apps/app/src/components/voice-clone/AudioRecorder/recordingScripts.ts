 ...
 *
 * English original:
 *   "The old wooden bridge stretched across the quiet river while
 *    a gentle breeze moved through the tall trees nearby children
 *    laughed in the distance as a small fishing boat drifted slowly
...
export const RECORDING_SCRIPTS: Record<string, string> = {
  ...
  bn: "পুরানো কাঠের সেতুটি শান্ত নদীর ওপর বিস্তৃত ছিল যখন মৃদু বাতাস লম্বা গাছের মধ্যে দিয়ে বয়ে যাচ্ছিল কাছেই দূরে শিশুরা হাসছিল যখন একটি ছোট মাছ ধরার নৌকা ধীরে ধীরে শান্ত জলের ওপর ভেসে যাচ্ছিল",

  te: "పాత కలప వంతెన ప్రశాంతమైన నదిపై విస్తరించి ఉంది తేలికపాటి గాలి పొడవైన చెట్ల మధ్య నుండి వీస్తూ ఉండగా సమీపంలో పిల్లలు దూరంగా నవ్వుతూ ఉన్నారు ఒక చిన్న చేపల పడవ ప్రశాంతమైన నీటిపై నెమ్మదిగా కదులుతూ ఉంది",
  ...
  zh: "古老的木桥横跨在宁静的河面上轻柔的微风穿过高大的树林附近孩子们在远处欢笑着一艘小小的渔船在平静的水面上缓缓漂流",
  ...
  arb: "امتد الجسر الخشبي القديم عبر النهر الهادئ بينما كانت نسمة لطيفة تمر بين الأشجار العالية القريبة وكان الأطفال يضحكون في البعيد بينما كان قارب صيد صغير ينجرف ببطء على طول المياه الهادئة",
  ...
  pt: "A velha ponte de madeira se estendia sobre o rio tranquilo enquanto uma brisa suave passava entre as árvores altas perto dali crianças riam ao longe enquanto um pequeno barco de pesca flutuava lentamente pela água calma",
  ...
  ja: "古い木の橋が静かな川に架かっていた穏やかな風が背の高い木々の間を吹き抜けていた近くで子供たちが遠くで笑っていた小さな釣り船が穏やかな水面をゆっくりと漂っていた",
